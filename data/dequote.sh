...
#sed -i "s/[\"\„\“]//g" ../tur1/os/local_parties_27.10.2019.txt
...
#sed -i "s/Местна коалиция Движение ЗАЕДНО за промяна (Коалиция Движение ЗАЕДНО за промяна; ПП ЕДИННА НАРОДНА ПАРТИЯ; ПП ДВИЖЕНИЕ ГЕРГЬОВДЕН; ПП СЪЮЗ НА СВОБОДНИТЕ ДЕМОКРАТИ; ПП ДВИЖЕНИЕ БЪЛГАРИЯ НА ГРАЖДАНИТЕ; ПП БЪЛГАРСКИ ЗЕМЕДЕЛСКИ НАРОДЕН СЪЮЗ; ПП СЪЮЗ НА ДЕМОКРАТИЧНИТЕ СИЛИ)/Местна коалиция Движение ЗАЕДНО за промяна (Коалиция Движение ЗАЕДНО за промяна, ПП ЕДИННА НАРОДНА ПАРТИЯ, ПП ДВИЖЕНИЕ ГЕРГЬОВДЕН, ПП СЪЮЗ НА СВОБОДНИТЕ ДЕМОКРАТИ, ПП ДВИЖЕНИЕ БЪЛГАРИЯ НА ГРАЖДАНИТЕ, ПП БЪЛГАРСКИ ЗЕМЕДЕЛСКИ НАРОДЕН СЪЮЗ, ПП СЪЮЗ НА ДЕМОКРАТИЧНИТЕ СИЛИ)/g" ../tur1/ko/local_candidates_27.10.2019.txt


#sed -i "s/[\"\„\“]//g" /home/nikola/projects/semanticElections/gdrive/data/cikOpenData/mi2015/tur1/ko/local_candidates_25.10.2015.txt
#sed -i "s/[\"\„\“]//g" /home/nikola/projects/semanticElections/gdrive/data/cikOpenData/mi2015/tur2/ko/local_candidates_01.11.2015.txt
...
#sed -i "s/[\"\„\“]//g" /home/nikola/projects/dgood/semanticElections/gdrive/data/cikOpenData/pi2022/*.txt
sed -i "s/[\"\„\“]//g" /home/nikola/projects/dgood/semanticElections/gdrive/data/cikOpenData/pi2023/*.txt
